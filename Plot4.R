...
plot(elecdata$Global_active_power~elecdata$dateTime,type = 'l',ylab = "Global Active Power",xlab = "")
plot(elecdata$Voltage~elecdata$dateTime,type = 'l',ylab = "Voltage",xlab = "datetime")
...
plot(elecdata$Global_reactive_power~elecdata$dateTime,type = 'l',ylab = "Global_Reactive_Power",xlab = "datetime")
